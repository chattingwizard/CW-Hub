...
export const modules: HubModule[] = [
  ...
  },
  {
    ...
    type: 'internal',
    path: '/knowledge-base',
    roles: ['owner', 'admin', 'hiring_manager', 'team_leader', 'script_manager', 'va', 'chatter'],
    section: 'tools',
  },
  {
    id: 'hiring-workflow',
    ...
    roles: ['owner', 'admin', 'hiring_manager'],
    section: 'tools',
  },
  ...
  // ── Training ──────────────────────────────────────────────
  {
    ...
    type: 'internal',
    path: '/school',
    roles: ['owner', 'admin', 'hiring_manager', 'team_leader', 'chatter', 'recruit'],
    section: 'training',
    dividerBefore: true,
  },
